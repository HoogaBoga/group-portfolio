...
function EmployeeCard({
  ...
  return (
    <div
      className={`${bgClass} ${textClass} rounded-xl shadow-md p-8 w-96 max-w-full transition-all duration-300 hover:shadow-lg`}
    >
      ...
      <p className="text-xl font-semibold mb-3 opacity-90 text-center">
        {role}
      </p>
      <p className="text-center mb-8 text-base leading-relaxed">
        {description}
      </p>
      <div className="flex justify-center">
        <button
          className={`${buttonBgClass} ${buttonTextClass} py-3 px-6 rounded-md font-medium text-lg`}
        >
          Portfolio
        </button>
      </div>
...
function Staff() {
  ...
  return (
    <section className="py-16 bg-white w-full flex flex-col items-center justify-center min-h-[calc(100vh+4rem)]">
      <h1 className="text-4xl md:text-5xl font-bold mb-12 underline text-white text-stroke-shadow">
        Meet the crew
      </h1>
