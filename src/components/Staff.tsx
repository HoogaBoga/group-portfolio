...
function EmployeeCard({
    name, role, description, image, mainColor, altColor, index, isVisible
}: EmployeeCardProps) {
    ...
    return (
        ...
        >
            ...
            <h3 className="text-2xl font-bold mb-2 text-center transition-colors duration-300">{name}</h3>
            <p className="text-lg font-semibold mb-3 opacity-90 text-center transition-opacity duration-300 hover:opacity-100">{role}</p>
            <p className="text-center mb-6 text-sm leading-relaxed transition-all duration-300">{description}</p>
            <div className="flex justify-center">
                <button className={`${buttonBgClass} ${buttonTextClass} py-2 px-4 rounded-md font-medium text-base transition-all duration-300 hover:scale-105 hover:shadow-lg`}>
                    Portfolio
                </button>
            </div>
        </div>
...
function Staff() {
    ...
    return (
        <section 
            ref={sectionRef}
            id="staff" 
            className="py-16 bg-white w-full flex flex-col items-center justify-center min-h-screen transition-all duration-1000"
        >
            <h1 
                ref={titleRef}
